...
**A quick and engaging web application to train and test your reaction time.**

## 🎯 The Challenge: Find the Number
...
* **Design:** Fully Responsive (Optimized for both **laptop and mobile devices**)

### Developed by a data entry clerk from **ScriptaIKE** aiming for peak performance!
